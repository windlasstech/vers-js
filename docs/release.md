...
This document is the canonical maintainer runbook for releasing `@windlass/vers-js` to
...
`@windlass/vers-js` package on npmjs.com:
...
on the npm registry. The `@windlass/vers-js` v0.1.0 first release therefore uses a
...
Use `npm publish "./windlass-vers-js-X.Y.Z.tgz" --access public --provenance-file
"./windlass-vers-js-X.Y.Z.tgz.intoto.jsonl"` from `${{ runner.temp }}` in the Trusted
...
- `windlass-vers-js-X.Y.Z.tgz.intoto.jsonl` — SLSA Build L3 provenance generated by the
