...
An ADR captures an important architectural decision made along with its context and consequences. It helps future contributors understand *why* the project is built the way it is, not just *what* was built.
