...
### Finalization (ADR-0041–0050, 0052–0053)
...
### Release and Publishing (ADR-0051, 0054–)
...
| [0054](0054-use-slsa-builder-as-release-provenance-producer.md)         | Use slsa-builder as the release provenance producer     | accepted |
