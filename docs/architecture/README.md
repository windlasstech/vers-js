...
translate the accepted ADRs in `../decisions/` into concrete contracts that implementation and tests
must follow.
...
| [Build and Test](build-and-test.md)                 | Package scaffolding, output, and verification        | ADR-0002, ADR-0003, ADR-0011, ADR-0012, ADR-0013, ADR-0014, ADR-0036, ADR-0037, ADR-0038, ADR-0039, ADR-0040, ADR-0050, ADR-0053 |
